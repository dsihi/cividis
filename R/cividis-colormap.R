...
#'  map ('cividis'). Source: \url{https://github.com/BIDS/colormap/blob/master/option_d.py}.
#'
...
#'   \item G: Green value
#'   \item B: Blue value
#'   \item opt: The colormap "option" (A: magma; B: inferno; C: plasma; D: cividis)
#' }
"cividis.map"


#' Matplotlib 'cividis' color map
#'
#' This function creates a vector of \code{n} equally spaced colors along the
#' Matplolib 'cividis' color map created by \href{https://github.com/stefanv}{Stéfan van der Walt}
