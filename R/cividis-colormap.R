...
#' 'cividis' color map created by \href{https://github.com/jamienunez}{Jamie R. Nuñez}
#' and \href{https://github.com/smcolby}{Sean M. Colby}. This so-called "cividis" color palette
...
#'
#' @author
#' Marco Sciaini: \email{sciaini.marco@gmail.com}, \href{(https://twitter.com/msciain)}{@@msciain}
#' Cédric Scherer: \email{cedricphilippscherer@gmail.com}, \href{(https://twitter.com/CedScherer)}{@@CedScherer}
#'
#' @details
#'
